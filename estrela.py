...
class Sort:
    """ Classe para ordenar os vértices com base na soma do custo acumulado e heurística """
    ...
    def insert(self, vertex, cost, accumulated_cost):
        ...
        self.cities.sort(key=lambda x: x[2])  # Ordena pelo menor f(n)
...
class Map:
    """ Classe que cria o mapa com os vértices e distâncias """
...
class Routes:
    ...
    def search(self, current, accumulated_cost=0):
        """ Busca a melhor rota usando o algoritmo A* """
